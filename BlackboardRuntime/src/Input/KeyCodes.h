...
#ifndef BLACKBOARDENGINE_KEYCODES_H
#define BLACKBOARDENGINE_KEYCODES_H
...
#define BB_KEY_WORLD_1            161 /* non-US #1 */
#define BB_KEY_WORLD_2            162 /* non-US #2 */
...
#define BB_KEY_LAST               ODT_KEY_MENU

#endif //BLACKBOARDENGINE_KEYCODES_H
